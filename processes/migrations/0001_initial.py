# Generated by Django 5.2 on 2026-03-31 00:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('em_andamento', 'Em andamento'), ('suspenso', 'Suspenso'), ('arquivado', 'Arquivado'), ('encerrado', 'Encerrado')], default='em_andamento', max_length=20)),
                ...
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='processos', to='clients.clients')),
            ],
        ),
    ]
